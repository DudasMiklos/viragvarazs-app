...
class _CreateProductPageState extends State<CreateProductPage> {
  ...
  ImageProvider productImageProvider =
      Image.network("https://placehold.co/300x400.png").image;
        ...
        onSaveTap: () async {
          if (_formKey.currentState!.validate()) {
            ...
            await Provider.of<ProductProvider>(context, listen: false)
                .createProduct(_product, picture!)
                .then((value) {
              if (value == null) {
                MessageHelper.showToast("Sikeres termék létrehozás");
                AutoRouter.of(context).maybePop();
              } else {
                Forest.error(value.toString());
                MessageHelper.showToast(
                    "Hiba történt a termék létrehozása során");
              }
            });
          }
        },
                                  ...
                                  children: [
                                    CustomSmallElevatedButton(
                                      ...
                                      title: Provider.of<ProductProvider>(
                                                  ...
                                                  .generatedDescription ==
                                              ""
                                          ? 'Termék leírás generálása AI-al'
