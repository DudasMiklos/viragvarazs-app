...
class EditProductOptionSheet extends StatefulWidget {
  final OptionModel optionModel;
  const EditProductOptionSheet({super.key, required this.optionModel});

  @override
  State<EditProductOptionSheet> createState() => _EditProductOptionSheetState();
}

class _EditProductOptionSheetState extends State<EditProductOptionSheet> {
  ...
  @override
  void initState() {
    selectedColor = widget.optionModel.color;
    selectedSize = widget.optionModel.size;
    price = widget.optionModel.price.toString();
    isStock = widget.optionModel.stock == 1;
    isAvailable = widget.optionModel.available == 1;
    sku = widget.optionModel.sku;
    super.initState();
  }
