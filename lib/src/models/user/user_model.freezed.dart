...
class _$UserModelImpl implements _UserModel {
  _$UserModelImpl(
      ...
      required this.name,
      required this.email,
      @JsonKey(name: 'is_super') required this.isSuper});
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, email: $email, isSuper: $isSuper)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, isSuper);
